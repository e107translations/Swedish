...
|        Last Modified: 2017/02/10 11:17:01
|
|        $Author: tubbis_2 $
+---------------------------------------------------------------+
*/

define("CLOCK_MENU_L1", "Klockans menykonfiguration sparad");
define("CLOCK_MENU_L2", "Överskrift");
define("CLOCK_MENU_L3", "Uppdatera menyinställningar");
define("CLOCK_MENU_L4", "Klockans menykonfiguration");
define("CLOCK_MENU_L5", "Måndag,");
define("CLOCK_MENU_L6", "Tisdag,");
define("CLOCK_MENU_L7", "Onsdag,");
define("CLOCK_MENU_L8", "Torsdag,");
define("CLOCK_MENU_L9", "Fredag,");
define("CLOCK_MENU_L10", "Lördag,");
define("CLOCK_MENU_L11", "Söndag,");
