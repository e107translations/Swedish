...
|        Last Modified: 2017/02/10 13:12:36
|
|        $Author: tubbis_2 $
+---------------------------------------------------------------+
*/
define("LIST_MENU_1", "nyligen tillagda");
define("LIST_MENU_2", "av");
define("LIST_MENU_3", "den");
define("LIST_MENU_4", "i");
define("LIST_MENU_5", "dagar");
define("LIST_MENU_6", "Visa innehåll för hur många dagar?");
define("LIST_MENU_7", "");
define("LIST_MENU_8", "");
define("LIST_MENU_9", "");
define("LIST_MENU_10", "");
...
define("LIST_NEWS_2", "inga nyheter");
...
define("LIST_COMMENT_6", "dokument");
...
define("LIST_CHATBOX_1", "Chatt-ruta");
define("LIST_CHATBOX_2", "inga chatt-inlägg");
define("LIST_CALENDAR_1", "kalender");
define("LIST_CALENDAR_2", "inga händelser i kalendern");
...
define("LIST_LAN_1", "inga poster i");
