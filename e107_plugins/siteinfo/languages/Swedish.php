...
|        Last Modified: 2017/02/10 17:49:38
|
|        $Author: tubbis_2 $
+---------------------------------------------------------------+
*/

define("COMPLIANCE_L1", "W3C efterlevnad");
define("SITEBUTTON_MENU_L1", "Länk till oss");
define("POWEREDBY_L1", "Drivs av");
define("COUNTER_L1", "Adminbesök räknas inte.");
define("COUNTER_L2", "Denna sida idag");
define("COUNTER_L3", "totalt");
define("COUNTER_L4", "Denna sida sedan start");
