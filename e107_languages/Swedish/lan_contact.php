...
+----------------------------------------------------------------------------+
*/
define("LANCONTACT_00", "Kontakta oss");
define("LANCONTACT_01", "Kontaktuppgifter");
define("LANCONTACT_02", "Kontaktformulär");
define("LANCONTACT_03", "Skriv in ditt namn");
define("LANCONTACT_04", "Skriv in din e-postadress");
...
define("LANCONTACT_13", "Vänligen ange ett ämne");
define("LANCONTACT_14", "Skicka meddelandet till:");
define("LANCONTACT_15", "Felaktig kod angiven");
define("LANCONTACT_16", "Du måste vara [registrerad] och inloggad för att använda detta formulär.");
define("LANCONTACT_17", "Skriv in ditt namn.");
define("LANCONTACT_18", "Skriv in din mejladress.");
define("LANCONTACT_19", "Fyll i ämne för mejlet.");
