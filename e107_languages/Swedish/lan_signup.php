...
define("LAN_SIGNUP_13", "Nu kan du logga in i inloggningmenyn eller [here]");
...
define("LAN_SIGNUP_17", "Bekräfta att du är 13 år eller äldre.");
...
define("LAN_SIGNUP_60", "Återsändning av registreringsmejl begärd");
define("LAN_SIGNUP_61", "Sändandet lyckades");
define("LAN_SIGNUP_62", "Sändandet misslyckades");
define("LAN_SIGNUP_63", "Återställning av lösenordsmejl begärd");
define("LAN_SIGNUP_64", "Detta verkar inte vara giltig användar information");
...
define("LAN_SIGNUP_74", "Ditt konto har nu aktiverats, vänligen");
define("LAN_SIGNUP_75", "Registrering aktiverad");
define("LAN_SIGNUP_76", "Tackar! Du är nu en registrerad medlem på");
define("LAN_SIGNUP_77", "Denna sajt efterlever bestämmelserna i  The Children's Online Privacy Protection Act of 1998 (COPPA) och kan som sådan inte tillåta registreringar från personer under 13 år utan en skriftlig intygan från förälder eller vårdnadshavare. För mer information se COPPA");
define("LAN_SIGNUP_78", "Registrering");
define("LAN_SIGNUP_79", "Registrera");
define("LAN_SIGNUP_80", "Fyll i dina uppgifter nedan.");
define("LAN_SIGNUP_81", "Användarnamn");
define("LAN_SIGNUP_82", "Namnet du använder för att logga in");
define("LAN_SIGNUP_83", "Lösenord:");
define("LAN_SIGNUP_84", "Fyll i lösenord igen");
define("LAN_SIGNUP_85", "Användarnamn och lösenord skiljer på liten och stor bokstav");
define("LAN_SIGNUP_89", "Visat namn");
define("LAN_SIGNUP_90", "Namnet som kommer att synas på sidan");
define("LAN_SIGNUP_91", "Verkligt namn");
define("LAN_SIGNUP_93", "Signatur");
define("LAN_SIGNUP_94", "Avatar");
define("LAN_SIGNUP_95", "Fyll i koden som syns i bilden");
define("LAN_SIGNUP_96", "Registreringsuppgifter för");
define("LAN_SIGNUP_97", "Välkommen till");
...
define("LAN_SIGNUP_101", "Uppdatering av uppgifter misslyckades - Kontakta webbplatsansvarig");
...
define("LAN_SIGNUP_107", "Lösenordet måste innehålla minst [x] tecken och inkludera minst en VERSAL bokstav och en siffra.");
define("LAN_SIGNUP_108", "Måste vara en giltig mejladress");
define("LAN_SIGNUP_109", "är LäGes-känsligt och får inte innehålla mellanslag");
define("LAN_SIGNUP_110", "Ditt fullständiga namn");
define("LAN_SIGNUP_111", "Fyll i en URL till din bild eller välj en existerande avatar");
define("LAN_SIGNUP_112", "Du är för närvarande inloggad som huvudadministratör");
define("LAN_SIGNUP_113", "Prenumeration(er)");
define("LAN_SIGNUP_114", "Användarregistrering är tillfälligt avstängd");
define("LAN_SIGNUP_115", "Förhandsvisa Aktiveringsmejlet");
define("LAN_SIGNUP_116", "Förhandsvisa text efter att du har skickat");
define("LAN_SIGNUP_117", "Skicka en testaktivering");
define("LAN_SIGNUP_118", "till [x]");
define("LAN_SIGNUP_119", "Mejla inte");
