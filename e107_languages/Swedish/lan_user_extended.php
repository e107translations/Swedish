...
define("UE_LAN_9", "Fördefinierad lista");
define("UE_LAN_10", "Kryssruta");
define("UE_LAN_13", "Land");
define("UE_LAN_21", "Namn");
define("UE_LAN_22", "Typ");
define("UE_LAN_23", "Använd");
...
define("UE_LAN_TIMEZONE", "Tidzon");
define("UE_LAN_TIMEZONE_DESC", "Användarens tidzon( från fördefinierad lista)");
define("LAN_UE_FAIL_HOMEPAGE", "Felaktigt inlägg för heminställningar");
define("UE_LAN_SKYPE", "Skype");
define("UE_LAN_SKYPE_DESC", "Skype adress");
define("UE_LAN_GENDER", "Kön");
define("UE_LAN_GENDER_DESC", "Kön");
define("UE_LAN_MALE", "Man");
define("UE_LAN_FEMALE", "Kvinna");
