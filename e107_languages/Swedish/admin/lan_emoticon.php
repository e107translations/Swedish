...
+----------------------------------------------------------------------------+
*/
define("EMOLAN_1", "Uttryckssymbolers aktivering");
...
define("EMOLAN_PAGE_TITLE", "Uttrycksikoner");
define("EMOLAN_31", "Totalt [x] filer funna");
define("EMOLAN_32", "Okänt paket upptäcktes");
define("EMOLAN_33", "XML filformatet saknar stöd");
define("EMOLAN_34", "Saknar filer för paketet");
define("EMOLAN_35", "- raderad från databasen");
define("EMOLAN_37", "Ingen uttryckssymbol är vald");
