...
+----------------------------------------------------------------------------+
*/
define("LANG_LAN_00", "[x] kunde inte skapas. (Finns redan)");
define("LANG_LAN_01", "[x] raderades (om befintlig) och skapades.");
define("LANG_LAN_02", "[x] kunde inte raderas");
define("LANG_LAN_03", "Tabeller");
define("LANG_LAN_04", "Utgångna LANer");
...
define("LANG_LAN_50", "Administratörsareans språk");
define("LANG_LAN_100", "[x] raderad.");
define("LANG_LAN_101", "[x] kunde inte raderas");
define("LANG_LAN_103", "[x] skapades.");
define("LANG_LAN_104", "[x] inaktiverades utan åtgärd");
define("LANG_LAN_105", "Radera alla tabeller i [x]");
define("LANG_LAN_106", "Språk efter domännamn");
define("LANG_LAN_107", "Domänen bestämmer sajtens språk. Skriv in domänen utan 'www'");
define("LANG_LAN_121", "Kunde inte ladda");
define("LANG_LAN_124", "Definition");
define("LANG_LAN_126", "Inaktivera alla oanvända");
define("LANG_LAN_130", "Vanligt begrepp");
define("LANG_LAN_131", "Saknas från språkfilen");
define("LANG_LAN_132", "är en vanlig fras");
define("LANG_LAN_133", "Använd");
define("LANG_LAN_134", "i stället");
define("LANG_LAN_135", "Skriver över");
define("LANG_LAN_136", "Kunde inte skriva över");
define("LANG_LAN_137", "Åtgärdad");
define("LANG_LAN_140", "Håll nere CTRL-tangent för att välja flera. [br]För att kontrollera [b]lan_signup.php[/b] behöver du samtidigt välja [b]signup_shortcodes.php[/b] och [b]signup_template.php[/b].");
define("LANG_LAN_141", "Välj skript...");
define("LANG_LAN_142", "Känn av automatiskt");
define("LANG_LAN_143", "Specifik LAN-fil");
define("LANG_LAN_144", "Måste återaktiveras");
define("LANG_LAN_148", "Normalläge");
define("LANG_LAN_149", "Värde");
