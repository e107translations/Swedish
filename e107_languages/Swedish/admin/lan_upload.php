...
define("UPLLAN_4", "Inget ändrades - ingen uppdatering");
...
define("UPLLAN_51", "Lista uppladdningar");
define("UPLLAN_52", "Denna sida hjälper dig att skapa en fil för att hantera dina filuppladdningsrättigheter. Filen sparas som --SOURCE--. och måste kopieras till --DEST-- innan den börjar gälla.");
define("UPLLAN_54", "Filändelser");
define("UPLLAN_55", "Max uppladdningsstorlek");
define("UPLLAN_56", "Skapa fil");
define("UPLLAN_57", "Källa för värden");
define("UPLLAN_59", "Inställningar sparade till");
define("UPLLAN_60", "Flytta nu denna fil till");
define("UPLLAN_61", "Kunde inte skapa fil");
define("UPLLAN_62", "Nedladdningsplugin är inte installerad - aktivering ej möjlig");
define("UPLLAN_63", "Record flyttades till nedladdningar. [x]");
define("UPLLAN_64", "Hantera nedladdning");
define("UPLLAN_66", "Felaktig nedladdningssökväg");
define("UPLLAN_68", "SQL fel");
define("UPLLAN_69", "Importerad");
